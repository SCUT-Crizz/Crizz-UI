...
describe('Collapse.vue', () => {
  beforeAll(() => {
    ...
    headers = wrapper.findAll('.cr-collapse-item__header')
    contents = wrapper.findAll('.cr-collapse-item__wrapper')
  ...
  test('modalValue 变更', async () => {
    wrapper.setValue(['b'], 'modalValue')
  ...
  test('手风琴模式', async () => {
    ...
    headers = wrapper.findAll('.cr-collapse-item__header')
    contents = wrapper.findAll('.cr-collapse-item__wapper')
